...
def check_price():
    ...
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36","Accept-Encoding":"gzip, deflate", "Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8", "DNT":"1","Connection":"close", "Upgrade-Insecure-Requests":"1"}
...
# Script below checks and add that day's price to tracker every day, commented out this code as it would loop forever and
...
df = pandas.read_csv("D:\dataset&Data for datanaylytics\pycharm projects and files analytics\AmazonWebScraperDataset.csv")
print(df)
